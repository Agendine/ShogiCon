...
import agendine.draft.shogiandroid.R;
...
public class SplashActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (firstLaunch) {
            firstLaunch = false;
            setupSplash();
            App.loadAsynchronously("agendine.draft.shogiandroid.MainActivity",
                                   new Runnable() {
                                       @Override
                                       public void run() {
                                           proceed();
    ...
    public void proceed() {
        startActivity(new Intent("agendine.draft.shogiandroid.MAIN"));
        finish();
    }
